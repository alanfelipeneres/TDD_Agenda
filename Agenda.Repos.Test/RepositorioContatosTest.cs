...
namespace Agenda.Repos.Test
{
    ...
    public class RepositorioContatosTest
    {
        ...
        public void SetUp()
        {
            ...
            _repositorioContatos = new RepositorioContatos(_contatos.Object, _telefones.Object); //É necessário passar como parâmetro um objeto do tipo contato e outro do tipo telefone, por isso o ".Object"
        }
